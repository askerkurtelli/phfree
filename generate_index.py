...
# Delete previous version of index.html if it exists in the new location
    ...
    <div class="container">
        <div class="text-center mt-5">
            ...
            <form id="searchForm">
                ...
                <input type="text" id="searchInput" oninput="searchResults()" onload="initialhide()" placeholder="Start your PhD search">
            </form>
