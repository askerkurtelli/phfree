...
The idea is that, if this were a live website, this would be run once or twice a day before generating a new index. This would ensure that the website features up-to-date information.
...
This is the heart of the project. It uses the **os** and **pandas** libraries to delete the existing **index.html** and replace it with updated data from the most recent **output.csv**.
